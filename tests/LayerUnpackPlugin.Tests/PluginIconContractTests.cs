...
public sealed class PluginIconContractTests
{
    ...
    public void 所有文档工具和创建意图均可解析图标且保持入口数量()
    {
        ...
        new LayerUnpackPlugin.Plugin.LayerUnpackPluginModule().Configure(registration);
        ...
        Assert.Equal(2, registration.Icons.Count);
    ...
    {
        var module = new LayerUnpackPlugin.Plugin.LayerUnpackPluginModule();
        ...
        IWorkflowActionRegistration, IWorkbenchCommandRegistration
    {
        ...
        public PluginId PluginId => new("myavalonia.plugin.layer.unpack");
